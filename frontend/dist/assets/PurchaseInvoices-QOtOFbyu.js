import{r as m,u as pe,R as X,a4 as xe,a5 as me,a6 as he,a7 as ue,a8 as ge,a9 as be,aa as ye,ab as fe,p as e,V as je,S as Ne,a3 as ve,E as we,C as Se,B as H,z as Ie,y as De}from"./index-CPGRFPoA.js";import{g as Me}from"./ComponentRegistry-DFFt6TuW.js";import{P as Ce}from"./plus-0pBJo49N.js";import{F as $e}from"./filter-GYW4ITtG.js";import{P as K}from"./printer-Cmw_Pmcr.js";import{P as Pe}from"./pen-square-sDWyQdA0.js";import{T as Te}from"./trash-2-CJJmzTJU.js";import{X as W}from"./x-circle-SVP68Kyc.js";import{C as S}from"./check-circle-D4A7-IOV.js";const Ae=(i=new Date)=>{const x=i.getFullYear(),o=String(i.getMonth()+1).padStart(2,"0"),h=String(i.getDate()).padStart(2,"0");return`${x}-${o}-${h}`},ke=({status:i})=>{const x={draft:{color:"bg-gray-100 text-gray-800",icon:Se,label:"Draft"},confirmed:{color:"bg-blue-100 text-blue-800",icon:S,label:"Confirmed"},received:{color:"bg-green-100 text-green-800",icon:S,label:"Received"},paid:{color:"bg-green-100 text-green-800",icon:S,label:"Paid"},cancelled:{color:"bg-red-100 text-red-800",icon:W,label:"Cancelled"},closed:{color:"bg-gray-100 text-gray-800",icon:W,label:"Closed"}},o=x[i]||x.draft,h=o.icon;return e.jsxs("span",{className:`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${o.color}`,children:[e.jsx(h,{className:"h-3 w-3 mr-1"}),o.label]})},Ke=()=>{var P,T,A,k,E,F,L,R,z,V,_,q,O;const[i,x]=m.useState(""),[o,h]=m.useState(""),I=Ae(),[u,Z]=m.useState(I),[g,ee]=m.useState(I),[a,te]=m.useState(null),[se,D]=m.useState(!1),{openTab:ae}=pe(),re=X.useMemo(()=>{const t={search:i||void 0,status:o||void 0};return u&&(t.dateFrom=u),g&&(t.dateTo=g),t},[i,o,u,g]),{data:r,isLoading:ne,error:le,refetch:M}=xe(re,{refetchOnMountOrArgChange:!0}),[Ee,{isLoading:Fe}]=me(),[ie,{isLoading:Le}]=he(),[Re]=ue(),[ze]=ge(),[Ve]=be(),[_e]=ye(),[qe]=fe(),C=t=>{var p,b,y,f,j,N,U,G,Q,Y,B,J;if(!t)return;const n=window.open("","_blank");if(!n)return;const s=c=>c?String(c).replace(/[&<>"']/g,v=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[v]):"",l=(t.items||[]).map(c=>{var v,w;return`
      <tr>
  ...
  <div class="invoice-details">
    ...
    <div class="payment-info">
      ...
      <div class="section-content">
        ...
        <p><span class="font-medium">Amount:</span> ${Math.round(((G=t.pricing)==null?void 0:G.total)||0)}</p>
      </div>
    </div>
  </div>
