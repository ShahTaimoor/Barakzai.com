...
class SupplierRepository {
  ...
  async findAll(filters = {}, options = {}) {
    ...
    if (filters.search) {
      sql += ` AND (company_name ILIKE $${paramCount} OR name ILIKE $${paramCount} OR email ILIKE $${paramCount})`;
  ...
  async findWithPagination(filters = {}, options = {}) {
    ...
    if (filters.search) { countSql += ` AND (company_name ILIKE $${paramCount} OR name ILIKE $${paramCount} OR email ILIKE $${paramCount})`; countParams.push(`%${filters.search}%`); paramCount++; }
